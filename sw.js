...
const CACHE = 'csr-demo-v5';

const SHELL = [
  './', './index.html', './styles.css', './app.js', './version.js', './manifest.webmanifest',
  './icons/icon-180.png', './icons/icon-192.png', './icons/icon-512.png',
  './vendor/leaflet/leaflet.js', './vendor/leaflet/leaflet.css',
  './src/buckets.js', './src/compliance.js', './src/demo.js', './src/geo.js', './src/guide.js', './src/matcher.js',
  './src/osm.js', './src/phrases.js', './src/privacy.js', './src/profile.js', './src/records.js', './src/replay.js', './src/router.js',
  './src/runEngine.js', './src/tunables.js', './src/units.js',
  './ui/audio.js', './ui/compass.js', './ui/dom.js', './ui/drive.js', './ui/feedback.js', './ui/gps.js', './ui/guide.js', './ui/history.js', './ui/limits.js',
